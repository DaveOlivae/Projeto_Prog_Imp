...
//Funcao para adicao de registro
void addAlug(const char *nome_do_csv) {
    ...
    //Teste de conflito de agendamentos com a funcao de comparacao
    rewind(pont_csv);
...
//Funcao para atualizacao de registro
